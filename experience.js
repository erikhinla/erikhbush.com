...
const gateCopy={out:'Consume and be consumed by AI tools without learning them and get passed by those who did.',back:'Continue Managing Digital Fog as AI\'s assistant, always busy but not building something scalable that moves you.',up:'It was never ours to carry. Eight answers. See where it shows up.'};
const gateUpHtml=document.body.dataset.page==='life'
  ?'It was never ours to carry.<br>Eight answers. See where it shows up.'
  :'It was never ours to carry.<br>Fifteen questions. See where it shows up.';
